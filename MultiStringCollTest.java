...
class MultiStringColl {
    ...
    public MultiStringColl(btNode node, int number) {
        c = null;
        uniqueCount = 0;
    }
    ...
    private static void printtree(btNode t) {
        if (t != null) {
            printtree(t.left);
            System.out.println();
            System.out.println("Root: " + t.info + " Count: " + t.count);
            if (t.left != null) {
                System.out.println("Left Child: " + t.left.info + " Count: " + t.left.count);
            }
            if (t.right != null) {
                System.out.println("Right Child: " + t.right.info + " Count: " + t.right.count);
            }
            printtree(t.right);
        }
    }
    ...
    class StringColl extends MultiStringColl {
    ...
    public class MultiStringCollTest {

//    public static void main(String[] args) {
//        MultiStringColl me = new MultiStringColl();
//        me.insert("flower");
//        me.insert("bubble");
//        me.insert("fox");
//        me.insert("apple");
